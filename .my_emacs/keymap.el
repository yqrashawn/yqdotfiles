...
(with-eval-after-load 'term
  ...
  (evil-define-key 'insert term-raw-map (kbd "C-o") 'term-kill-output)
  ...
  (evil-define-key 'insert term-raw-map (kbd "C-n") 'term-next-prompt)
  (evil-define-key 'insert term-raw-map (kbd "C-p") 'term-previous-prompt)
  (evil-define-key 'insert term-raw-map (kbd "C-d") 'term-send-eof)
