...
(push '("*Cargo Run*" :dedicated t :position right :stick nil :noselect nil) popwin:special-display-config)
(push '("*Cargo Build*" :dedicated t :position right :stick nil :noselect nil) popwin:special-display-config)
