...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(imenu-anywhere buffer-flip yasnippet saveplace phi-search babel-repl jscs pdf-tools vlf eslint-fix slime js-comint)
