...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(yasnippet saveplace zoom-window phi-search js2-highlight-vars babel-repl jscs vlf eslint-fix slime js-comint)
