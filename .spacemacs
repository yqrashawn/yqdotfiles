...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(vlf company-flx fzf imenu-anywhere buffer-flip saveplace phi-search babel-repl jscs eslint-fix slime js-comint)
