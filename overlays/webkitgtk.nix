{ lib, stdenv, runCommand, fetchurl, fetchgit, fetchpatch, perl, python3, ruby
, bison, gperf, cmake, ninja, pkg-config, gettext, gobject-introspection
, libnotify, gnutls, libgcrypt, libgpg-error, gtk3, wayland, libwebp, libwpe
, libwpe-fdo, enchant2, xorg, libxkbcommon, libepoxy, at-spi2-core, libxml2
, libsoup, libsecret, libxslt, harfbuzz, libpthreadstubs, pcre, nettle, libtasn1
, p11-kit, libidn, libedit, readline, apple_sdk, libGL, libGLU, mesa, libintl
, lcms2, libmanette, openjpeg, geoclue2, sqlite, enableGLES ? stdenv.isLinux
, gst-plugins-base, gst-plugins-bad, woff2, bubblewrap, libseccomp, systemd
, xdg-dbus-proxy, substituteAll, glib, addOpenGLRunpath
, enableGeoLocation ? true, withLibsecret ? true
, systemdSupport ? stdenv.isLinux, gi-docgen }:
...
stdenv.mkDerivation rec {
  ...
  src = fetchurl {
    ...
    # hash = "sha256-VrltvbOzxCUBRx8bnsJoZC1WJPGq1HPTq0+GLSYz+dc=";
  };
  ...
  patches = lib.optionals stdenv.isLinux [
    ...
    # (fetchpatch {
    #   url =
    #     "https://git.yoctoproject.org/poky/plain/meta/recipes-sato/webkit/webkitgtk/0001-Fix-build-without-opengl-or-es.patch";
    ...
    (fetchpatch {
      url =
        "https://github.com/WebKit/WebKit/commit/68822eb73f2cdd843dbe6bdd346e7268b279650b.patch";
    ...
    (fetchpatch {
      url =
        "https://github.com/WebKit/WebKit/commit/6bb3f1342f342358061b525c7b8f077b7b5ed15b.patch";
  ...
  ] ++ lib.optionals (!systemdSupport) [ "-DUSE_SYSTEMD=OFF" ]
  ++ lib.optionals enableGLES [ "-DENABLE_GLES2=ON" ];
