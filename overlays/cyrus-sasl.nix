{ lib, stdenv, fetchurl, openssl, openldap, libkrb5, db, gettext, pam
, fixDarwinDylibNames, autoreconfHook, enableLdap ? false, buildPackages
, pruneLibtoolFiles, nixosTests, cyrus_sasl_xoauth2 }:
...
stdenv.mkDerivation rec {
  ...
  buildInputs = [ openssl db gettext libkrb5 ]
  ...
  postInstall = ''
    ...
    cp ${getLib cyrus_sasl_xoauth2}/lib/sasl2/libxoauth2.0.so $out/lib/sasl2/
  '';
