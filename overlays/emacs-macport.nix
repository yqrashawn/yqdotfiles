{ lib, stdenv, fetchFromBitbucket, fetchurl, ncurses, pkg-config, texinfo
, libxml2, gnutls, gettext, autoconf, automake, jansson, libgccjit
, autoreconfHook, AppKit, Carbon, Cocoa, IOKit, OSAKit, Quartz, QuartzCore
, WebKit, Metal, ImageCaptureCore, GSS, ImageIO # These may be optional
, sigtool }:
...
stdenv.mkDerivation rec {
  ...
  macportVersion = "ec519b7103dc9d27d0070c89fbce23f8bc0f8a0d";
  ...
  src = fetchFromBitbucket {
    ...
    repo = "emacs-mac";
    rev = macportVersion;
    hash = "sha256-iWzX83KVmkqJK7gJUVWAWwPCDsxyG/XwABZ/dWn38ss=";
  };
