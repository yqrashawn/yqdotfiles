...
(map!
 ...
 (:leader
  (:prefix-map ("o" . "open")
               (:prefix ("c" . "chat")
                ...
                :desc "Chat" "c" #'slack-select-rooms
                :desc "Chat" "C" #'slack-channel-select
                :desc "IM" "i" #'slack-im-select))
 ...
 (:after gptel
         ...
         (:map gptelt-auq-buffer-mode-map
          :n "1" #'gptelt-auq--select-option-interactive
          :n "2" #'gptelt-auq--select-option-interactive
          :n "3" #'gptelt-auq--select-option-interactive
          :n "4" #'gptelt-auq--select-option-interactive
          :n "5" #'gptelt-auq--select-option-interactive
          :n "6" #'gptelt-auq--select-option-interactive
          :n "7" #'gptelt-auq--select-option-interactive
          :n "8" #'gptelt-auq--select-option-interactive
          :n "9" #'gptelt-auq--select-option-interactive
          :n "RET" #'gptelt-auq--confirm-selection
          :n "q" #'gptelt-auq-skip
 ...
 (:after magit
         (:map magit-hunk-section-map
          :gn "RET" #'magit-diff-visit-worktree-file
