...
(when (fboundp 'gptelt-make-tool)
  (gptelt-make-tool
   ...
   :description (concat "Read a file from the local filesystem. "
                        ...
                        "The returned result includes a description line with the total lines in the file, and the start/end line numbers of the wrapped content. "
  ...
  (gptelt-make-tool
   ...
   :description (concat "Read a buffer by buffer name. "
                        ...
                        "Optional: offset (line number to start at), limit (number of lines). "
                        "The returned result includes a description line with the total lines in the buffer, and the start/end line numbers of the wrapped content. "
                        "The content is wrapped with ␂ at the start and ␃ at the end.")
