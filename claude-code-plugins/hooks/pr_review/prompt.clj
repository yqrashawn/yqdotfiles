     ...
     (when (seq (str verdict-tag))
       (section "Your verdict line"
         (str "Write your verdict at column 0, exactly once, with THIS pass's"
              ...
              " describes.\n\n"
              "The tag is minted for this pass and never reused. It is what"
              " separates your\nanswer from a previous pass's verdict, which"
              " you may quote while verifying\nclosure: quote those verbatim"
              " -- they carry their own tag, or none, and cannot\nbe read as"
              " yours. Never write this tag on any line but your own final"
              " verdict."))) 
